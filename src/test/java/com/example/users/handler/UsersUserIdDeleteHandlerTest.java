...
@Ignore
public class UsersUserIdDeleteHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UsersUserIdDeleteHandlerTest.class);
    ...
    @Test
    public void testUsersUserIdDeleteHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/users/xheXqvPXPw";
