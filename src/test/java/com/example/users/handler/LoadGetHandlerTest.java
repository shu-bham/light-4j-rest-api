...
@Ignore
public class LoadGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(LoadGetHandlerTest.class);
    ...
    @Test
    public void testLoadGetHandlerTest() throws ClientException {
