...
@Ignore
public class UsersUserIdGetHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UsersUserIdGetHandlerTest.class);
    ...
    @Test
    public void testUsersUserIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/users/MgAxHsNEEVheoPluBMenquzgqIiqj";
