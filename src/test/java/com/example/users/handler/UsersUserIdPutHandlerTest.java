...
@Ignore
public class UsersUserIdPutHandlerTest {
    @ClassRule
    public static TestServer server = TestServer.getInstance();

    static final Logger logger = LoggerFactory.getLogger(UsersUserIdPutHandlerTest.class);
    ...
    @Test
    public void testUsersUserIdPutHandlerTest() throws ClientException {
        ...
        String requestUri = "/v1/users/HoJRLRoFIQVqJp";
