...
import com.example.users.service.UsersUserIdPutService;
...
*/
public class UsersUserIdPutHandler implements LightHttpHandler {
    UsersUserIdPutService service;

    public UsersUserIdPutHandler () {
        this.service = new UsersUserIdPutService ();
    }
    ...
    public void handleRequest(HttpServerExchange exchange) throws Exception {
        ...
        User requestBody = Config.getInstance().getMapper().convertValue(bodyMap, User.class);
